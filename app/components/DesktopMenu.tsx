                                ...
                                <ul className="mt-4">
                                    <Link href="/" className='group'>
                                        <li className="flex items-center">
                                            <div className="border border-text-100 group-hover:border-blue-500 h-fit w-fit rounded-full p-[2px]">
                                                <span className="block w-[40px] h-[40px] overflow-hidden relative rounded-full group-hover:border-blue-500">
                                                    <Image
                                            ...
                                            <span className="ml-3 h-[40px] border-b px-1 flex max-w-max items-center group-hover:text-blue-500">
                                                Ski & Snowboard
                                            </span>
                                        </li>
                                    </Link>
                                ...
                                <div className="mt-4 flex flex-wrap gap-y-6">
                                    {["ASOS Curve & Plus size", "Maternity", "Petite", "Tall"].map(itm =>
                                        <Link href="/" key={itm} className="flex-[50%] group">
                                            <div className="border border-text-100 group-hover:border-blue-500 h-fit w-fit rounded-full p-[2px] mx-auto">
                                                <span className="relative block h-[78px] w-[78px] mx-auto overflow-hidden rounded-full group-hover:border-blue-500 border-text-200">
